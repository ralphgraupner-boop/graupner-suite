"""
Portal v4 – Auth-Utilities (isoliert)
...
PORTAL_V2_TOKEN_AUD = "portal-v2-customer"
...
def _decode_session_token(token: str) -> dict:
    return jwt.decode(token, JWT_SECRET, algorithms=["HS256"], audience=PORTAL_V2_TOKEN_AUD)


async def get_current_customer(authorization: str = Header(None)):
    """FastAPI-Dependency für Kunden-Routes im Portal v4."""
