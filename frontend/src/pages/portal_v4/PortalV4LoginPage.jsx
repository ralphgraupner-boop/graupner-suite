...
export function PortalV4LoginPage() {
  ...
  const submit = async (e) => {
    ...
    try {
      ...
      localStorage.setItem("portal_v4_session", data.session);
      localStorage.setItem("portal_v4_account", JSON.stringify(data.account));
      navigate("/portal-v4/app");
    } catch {
      setError("Verbindung fehlgeschlagen.");
    } finally {
      setSubmitting(false);
  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-[#fafaf8] px-4" data-testid="portal-v2-login-page">
      <div className="bg-white rounded-2xl shadow-lg w-full max-w-md p-8 space-y-6">
        ...
        {error && (
          <div className="flex items-start gap-2 p-3 rounded-lg bg-red-50 text-red-700 text-sm" data-testid="portal-v2-login-error">
        ...
        <form onSubmit={submit} className="space-y-4">
          {!token && (
            <label className="block">
              ...
              <input
                ...
                data-testid="portal-v2-login-email"
              />
            </label>
          )}
          <label className="block">
            ...
            <input
              ...
              className="w-full mt-1 px-3 py-2 border rounded-lg text-sm focus:outline-none focus:ring-2 focus:ring-[#14532D]/30"
              data-testid="portal-v2-login-password"
            />
          </label>
          ...
          <button
            ...
            data-testid="portal-v2-login-submit"
          >
...
export default PortalV4LoginPage;
