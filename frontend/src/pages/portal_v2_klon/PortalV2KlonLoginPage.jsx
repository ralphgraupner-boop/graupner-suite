...
export function PortalV2KlonLoginPage() {
  ...
  const submit = async (e) => {
    ...
    try {
      ...
      localStorage.setItem("portal_v2_session", data.session);
      localStorage.setItem("portal_v2_account", JSON.stringify(data.account));
      navigate("/portal-v2-klon/app");
    } catch {
      setError("Verbindung fehlgeschlagen.");
    } finally {
      setSubmitting(false);
...
export default PortalV2KlonLoginPage;
