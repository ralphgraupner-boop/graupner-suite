...
/**
 * Portal v3 – Import aus module_kunden
 * Modal mit Kundenliste, Suche, Status-Filter, Bulk-Select.
 */
export function PortalV3ImportDialog({ open, onClose, onImported }) {
  ...
  const load = async () => {
    ...
    try {
      ...
      const res = await api.get("/portal-v3/admin/kunden-quelle", { params });
  ...
  const doImport = async () => {
    ...
    setImporting(true);
    try {
      const res = await api.post("/portal-v3/admin/accounts/import-from-kunden", {
  ...
  return (
    <div className="fixed inset-0 bg-black/50 z-50 flex items-center justify-center p-4" onClick={onClose}>
      <div
        ...
        data-testid="portal-v3-import-dialog"
      >
        {/* Header */}
        <div className="px-5 py-4 border-b flex items-center justify-between">
          ...
          <button onClick={onClose} className="p-2 rounded-lg hover:bg-muted" data-testid="portal-v3-import-close">
            <X className="w-5 h-5" />
          </button>
        </div>
        ...
        <div className="px-5 py-3 border-b flex flex-wrap gap-2 items-center">
          <div className="relative flex-1 min-w-[200px]">
            ...
            <input
              ...
              data-testid="portal-v3-import-search"
            />
          </div>
          <select
            value={statusFilter}
            ...
            data-testid="portal-v3-import-status-filter"
          >
          ...
          <button
            ...
            data-testid="portal-v3-import-select-all"
          >
              ...
              {filtered.map(k => {
                ...
                return (
                  <label
                    ...
                    data-testid={`portal-v3-import-row-${k.id}`}
                  >
                    <input
                      type="checkbox"
                      checked={checked}
        ...
        <div className="px-5 py-3 border-t flex items-center justify-between">
          ...
          <div className="flex gap-2">
            <button
              ...
              disabled={importing}
              data-testid="portal-v3-import-cancel"
            >
              Abbrechen
            </button>
            <button
              ...
              data-testid="portal-v3-import-confirm"
            >
...
export default PortalV3ImportDialog;
