...
const HELP_SECTIONS = [
  ...
  {
    id: "betterbird-helfer",
    icon: Mail,
    title: "Betterbird-Helfer installieren (Mail mit einem Klick)",
    intro: "Damit beim Klick auf 'Betterbird direkt' Ihr Mailprogramm automatisch mit fertiger E-Mail UND PDF-Anhang aufgeht, muss einmalig pro PC ein kleiner Helfer installiert werden. Das dauert ca. 5 Minuten und braucht keine Admin-Rechte.",
    lines: [
      "Voraussetzung: Betterbird ist installiert (Standard: C:\\Program Files\\Betterbird\\betterbird.exe).",
      "1. Den Ordner 'windows-helfer' aus dem Projekt auf den PC holen (über 'Save to Github' landet er im Repository – von dort herunterladen).",
      "2. Im Ordner auf 'install.bat' doppelklicken.",
      "3. Der Installer sucht Betterbird automatisch, kopiert das Skript nach C:\\Graupner und richtet das Protokoll 'bbcompose://' ein.",
      "4. Am Ende erscheint eine Erfolgsmeldung – fertig.",
      "5. In der Suite: Dokument öffnen → 'Mailprogramm' → oben 'Betterbird direkt' wählen → Betterbird öffnet sich mit PDF-Anhang.",
      "Pro PC nur einmal nötig (z. B. bei Ralph und bei Thorsten getrennt).",
      "Öffnet 'Betterbird direkt' nichts? Dann ist der Helfer auf diesem PC noch nicht installiert – einfach Schritte 1–4 nachholen.",
      "Fallback ganz ohne Installation: im selben Dialog '.eml herunterladen' wählen und die Datei per Doppelklick in Betterbird öffnen.",
      "Hinweis: Sonderzeichen (Apostroph ', Komma, Zeilenumbruch) in Betreff/Text können den direkten Aufruf stören – dann den .eml-Weg nutzen.",
    ],
  },
  {
    id: "kunden",
  ...
  },
  {
    id: "rechnungen-v2",
    icon: FileText,
    title: "Rechnungen (Neu) - BETA - GoBD-konform mit Verweis",
    intro: "Das neue Rechnungs-Modul läuft parallel zum alten. Es erstellt GoBD-konforme Rechnungen mit Verweis auf Auftragsbestätigung oder Angebot. Separater Nummernkreis RV2-... damit beide Module sich nicht vermischen.",
    lines: [
      "1. Aktivieren: Einstellungen → Diverses/Info → 'Rechnungen (Neu)' einschalten → Seite lädt neu.",
      "2. Neuer Menüeintrag erscheint links: 'Rechnungen (Neu)' mit BETA-Label.",
      "3. Button 'Rechnung erstellen' → Dialog wählt bestehende Auftragsbestätigung.",
      "4. Zwei Varianten zur Wahl: Kurz-Rechnung (eine Zeile mit Verweis) oder Vollrechnung (alle Positionen).",
      "5. System zieht automatisch: Kunde, Positionen/Summe, Anzahlung, Leistungsdatum (aus letztem Einsatz oder heute).",
      "6. Automatischer Verweis: 'Leistungen gemäß Auftragsbestätigung Nr. AB-YYYY-NNNN vom DD.MM.YYYY'.",
      "7. PDF öffnet in neuem Tab - enthält alle §14 UStG Pflichtfelder + 2-Jahre-Aufbewahrungshinweis.",
      "8. Bei Kleinbeträgen (< 250 € brutto): automatisches 'Kleinbetrag'-Label.",
      "9. 'Gedruckt'-Button: manuell setzen wenn Rechnung raus ist → dann nicht mehr bearbeitbar.",
      "10. 'Als bezahlt markieren': grüner Haken wenn Zahlungseingang.",
      "11. Alter Rechnungs-Bereich bleibt unberührt - beide Module laufen parallel.",
      "12. Deaktivieren jederzeit möglich: Einstellungen → Feature-Flag ausschalten → Menüeintrag verschwindet, Daten bleiben gespeichert.",
    ],
  },
  {
