...
const WysiwygDocumentEditor = ({ type = "quote" }) => {
  ...
  const [settingsTab, setSettingsTab] = useState("settings"); // "settings" | "stammdaten" | "blocks"
  ...
  // Stammdaten Panel für Slide-Over
  ...
  // Blöcke Panel für Slide-Over
  const BloeckePanel = ({ blocks, onDelete, onRefresh }) => {
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
        {blocks.map(block => (
          <div key={block.id} className="border rounded-sm p-4 bg-card">
            ...
            <button onClick={() => { insertLeistungsBlock(block); setShowSettings(false); }}
    ...
    <div className="min-h-screen bg-slate-100">
      ...
      <div className="pt-14 lg:pt-20 pb-4 lg:pb-8 px-2 lg:px-4">
        <div className="lg:grid lg:grid-cols-[340px_1fr_300px] lg:gap-4 lg:max-w-[1600px] lg:mx-auto">
          ...
          >
            {/* Document Header - Briefkopf + DIN 5008 Brieffenster */}
